...
public class CrazyStreams {
    ...
    public Map<String, List<Account>> groupAccountsByEmailDomain() {
        return accounts.stream()
                .collect(groupingBy(CrazyStreams::extractEmailDomain));
    }
    ...
    static String extractEmailDomain(Account account) {
    ...
    public Map<Month, String> groupCommaSeparatedFirstNamesByBirthdayMonth() {
        return accounts.stream()
                .collect(groupingBy(a -> a.getBirthday().getMonth(),
                        mapping(Account::getFirstName, Collectors.joining(", "))));
    }
    ...
    public Map<Month, BigDecimal> groupTotalBalanceByCreationMonth() {
        return accounts.stream()
                .collect(groupingBy(a -> a.getCreationDate().getMonth(), mapping(Account::getBalance,
